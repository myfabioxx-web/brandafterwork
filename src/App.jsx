    ...
    <div className="pointer-events-none fixed inset-0 opacity-[0.03] animate-grain mix-blend-soft-light bg-[url('https://www.transparenttextures.com/patterns/asfalt-dark.png')]" />
      <div className="background-grid relative min-h-screen animate-smoothAppear overflow-hidden before:absolute before:inset-0 before:pointer-events-none before:bg-[radial-gradient(circle_at_var(--x)_var(--y),rgba(250,204,21,0.12),transparent_220px)] bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.08),#050607_38%),linear-gradient(to_bottom,#050607,#07090c)] text-white">
       <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-[10%] top-[20%] h-2 w-2 animate-pulse rounded-full bg-yellow-300/40 blur-[1px]" />
          <div className="absolute left-[75%] top-[30%] h-3 w-3 animate-pulse rounded-full bg-yellow-200/30 blur-[2px]" />
          <div className="absolute left-[60%] top-[70%] h-2 w-2 animate-pulse rounded-full bg-yellow-400/30 blur-[1px]" />
          <div className="absolute left-[20%] top-[80%] h-2 w-2 animate-pulse rounded-full bg-yellow-300/20 blur-[1px]" />
      </div>
      ...
      <section className="fade-section relative overflow-hidden mx-auto grid max-w-7xl gap-8 px-4 py-10 md:px-6 md:py-16 lg:grid-cols-2">
        ...
        <div className="group relative overflow-hidden rounded-[2.5rem] animate-borderGlow border border-white/10 bg-black shadow-[0_0_100px_rgba(250,204,21,0.12)] transition duration-700 hover:shadow-[0_0_120px_rgba(250,204,21,0.18)] md:rounded-[2.5rem]">
          ...
          <img
            src={heroImage}
              className="w-full h-full object-cover animate-floatingHero animate-imageFade transition-all duration-[2000ms] ease-out group-hover:scale-[1.08] brightness-105 contrast-110" 
            alt="Podcast studio"
          />
        </div>
      </section>
