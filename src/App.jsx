  ...
  return (
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.06),#050607_45%)] text-white">
      ...
      <section className="relative overflow-hidden mx-auto grid max-w-7xl gap-8 px-4 py-10 md:px-6 md:py-16 lg:grid-cols-2">
        <div className="absolute top-0 left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-yellow-400/5 blur-[140px] animate-floatGlow" />  
      ...
      <section className="mx-auto max-w-7xl px-4 pt-10 pb-14 md:px-6 md:pb-16">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {contentItems.map((item, i) => (
            <div
               key={i}
               className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] backdrop-blur-2xl transition-all duration-500 hover:-translate-y-4 hover:border-yellow-400/40 hover:bg-white/[0.05] hover:shadow-[0_0_80px_rgba(250,204,21,0.22)]"
               >
              <img 
                src={item.image} 
